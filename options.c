...
#error "FIO_HAVE_IOPRIO_CLASS requires FIO_HAVE_IOPRIO"
	...
	{
		.name	= "cgroup_read_iops",
		.lname	= "Cgroup read iops",
		.type	= FIO_OPT_STR_STORE,
		.off1	= offsetof(struct thread_options, cgroup_read_iops),
		.help	= "Use given read iops for cgroup",
		.parent	= "cgroup",
		.category = FIO_OPT_C_GENERAL,
		.group	= FIO_OPT_G_CGROUP,
	},
    {
        .name   = "cgroup_write_iops",
        .lname  = "Cgroup write iops",
        .type   = FIO_OPT_STR_STORE,
        .off1   = offsetof(struct thread_options, cgroup_write_iops),
        .help   = "Use given write iops for cgroup",
        .parent = "cgroup",
        .category = FIO_OPT_C_GENERAL,
        .group  = FIO_OPT_G_CGROUP,
    },
	{
		.name	= "cgroup_read_bps",
		.lname	= "Cgroup read bps",
		.type	= FIO_OPT_STR_STORE,
		.off1	= offsetof(struct thread_options, cgroup_read_bps),
		.help	= "Use given read bps for cgroup",
		.parent	= "cgroup",
		.category = FIO_OPT_C_GENERAL,
		.group	= FIO_OPT_G_CGROUP,
	},
	{
        .name   = "cgroup_write_bps",
        .lname  = "Cgroup write bps",
        .type   = FIO_OPT_STR_STORE,
        .off1   = offsetof(struct thread_options, cgroup_write_bps),
        .help   = "Use given write bps for cgroup",
        .parent = "cgroup",
        .category = FIO_OPT_C_GENERAL,
        .group  = FIO_OPT_G_CGROUP,
    },
